...
public enum enumCommands
{
    ...
    GO("go", "gehen"), QUIT("quit", "beenden"), HELP("help", null), LOOK("look", null), SCREAM("scream", null), BACK("back", null), TAKE("take", null), DROP("drop", null), ITEMS("items", null), UNKNOWN("?", null);
